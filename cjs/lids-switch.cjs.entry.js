...
const Switch = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("label", { class: 'lids-switch-form-label' }, index.h("input", { class: 'lids-switch-form-checkbox', type: "checkbox", checked: this.checked, onInput: this.handleSwitch }), index.h("span", { class: { 'lids-switch-form-slider': true, 'lids-switch-form-slider--rounded': this.rounded } }))));
  }
};
Switch.style = lidsSwitchCss;

exports.lids_switch = Switch;
